...

// Convert/sanatize a file name


function convert_filename($text, $concat = '-'){
	
	$text = convert_accents($text);
	$text = strtolower($text);
	$text = preg_replace(array('/[\&]/', '/[\@]/'), array('-and-', '-at-'), $text);
	//$text = convert_smart_quotes($text);
	$text = str_replace(array(' ', '&', '\r\n', '\n', '+', ',', '//'), '-', $text);
	$text = preg_replace('`[^a-z0-9-\s_]`i', '', $text);
	$text = preg_replace('/[\s-]+/', '-', $text);
	$text = trim($text, '.-_');
	
	if($concat != '-'){
		$text = str_replace('-', $concat, $text);
		$text = uc_convert($text);
	}
